...
<div class="topic-content">
    ...
    <div class="tab-panel" id="overview-panel">
        ...
        <div class="section-block radar-section">
            ...
            <p class="section-description">Сводная оценка всех промтов проекта по четырём критериям: нейтральность, функциональная стабильность, логическая корректность и анти-галлюцинационный потенциал. Радар показывает средний профиль качества формулировок.</p>
        ...
        <div class="section-block">
            ...
            <div class="hero-stats-grid">
                ...
                <div class="hero-stat-card green">
                    <div class="hero-stat-header">
                        <span class="hero-stat-label">"Наши" источники</span>
                        <div class="hero-stat-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                                <polyline points="22 4 12 14.01 9 11.01"/>
...
/* Prompt Evaluations Table Styles */
.prompt-cell {
    max-width: 400px;
}
